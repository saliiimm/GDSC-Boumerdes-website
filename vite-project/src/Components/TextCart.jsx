...
function TextCart(props) {
  ...
  return (
    <div
      className={`px-[182PX] flex justify-between items-center pb-10 flex-col lg:${props.style}`}>
      <div className="text px-5 py-3 w-screen text-center lg:w-[533px] lg:text-left   ">
        <p className="text-gray-600 font-montserrat text-2xl  md:text-2xl font-normal">
          ...
          adipisicing elit. Temporibus voluptas ratione esse! Aut exercitationem
          corporis ratione asperiores suscipit omnis porro officiis atque.
